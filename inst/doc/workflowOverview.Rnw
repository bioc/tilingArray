...
\textit{as is}, with no pretense of it being finished. The data
structures need to be simplified and rationalized, and a lot of
documentation is missing. There are some very nice function in there,
though.
...
figuring out things for yourself or bugging me for explanation
...
%--------------------------------------------------
The function \Rfunction{normalizeByReference.R}.

%--------------------------------------------------
\section{Segmentation}
%--------------------------------------------------
\subsection{Point estimates}
Fast dynamic programming algorithm in the function
\Rfunction{segment.R}.
\subsection{Confidence intervals}
The \Rfunction{confint} method for \Rclass{segmentation} objects,

%--------------------------------------------------
\section{Visualization}
%--------------------------------------------------
The \Rfunction{plotAlongChrom}.
