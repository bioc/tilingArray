...
%--------------------------------------------------
The package is currently under rapid development. Some desirable
functionalities are still missing, others are poorly documented. 
If you want an easy-to-use package, please come back at a later time.
If you want to use this package, please do not expect a perfect and
finished user interface. Many parts are still quite rough. 
